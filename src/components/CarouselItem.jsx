...
const CarouselItem = () => (
  <div className='carousel-item'>
    ...
    <div className='carousel-item__details'>
      <div>
        <img className='carousel-item__details--img' src='../asset/imagenes/play-icon.png' alt='Play Icon' />
        <img className='carousel-item__details--img' src='../asset/imagenes/plus-icon.png' alt='Plus Icon' />
      </div>
